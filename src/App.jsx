...
function App() {
  return (
    <div className="app">
      ...
      <section id="contact" className="section contact">
        <div className="container text-center">
          ...
          <div className="contact-details">
            ...
            <div className="contact-item">
              <strong>טלפון:</strong> <a href="tel:0500000000">050-000-0000</a>
            </div>
            <div className="contact-item">
      ...
      <a href="https://wa.me/972500000000" className="whatsapp-float" target="_blank" rel="noopener noreferrer">
